...
# getting started
def getting_started():
    print(common.Section('getting started'))

    # construction
    print(common.SubSection('construction'))
    ...
    # operation: add
    print(common.SubSection('operations: add'))
    ...
    # operation: resize
    print(common.SubSection('operations: resize'))
    xb2 = torch.randn(4, 4)
    yb2 = xb2.view(16)
    zb2 = xb2.view(-1, 8)
    print('xb2 = ', xb2)
    ...
    # numpy bridge
    print(common.SubSection('numpy bridge'))
    # torch => numpy
    xc1 = torch.ones(5)
    print('xc1 = ', xc1)
    yc1 = xc1.numpy()
    ...
    # CUDA tensors
    print(common.SubSection('CUDA tensors'))
...
# autograd
def auto_grad():
    print(common.Section('Auto Grad'))
    # grad function
